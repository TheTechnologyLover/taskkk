                ...
                <div class="card profile-widget">
                    ...
                    <div class="profile-widget-description pb-0">
                        <div class="card-body p-0">
                                ...
                                <div class="dropdown card-widgets text-right">
                                    ...
                                    <div class="dropdown card-widgets">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a href="#" onclick="confirm('Are you sure ?')?document.getElementById('delete_user_<?php echo e($user->id); ?>').submit():'';" class="dropdown-item"><i class="mdi mdi-trash-can mr-1"></i><?php echo e(__('Delete')); ?></a>
                                    ...
                                    <span class="badge badge-info mr-1"><?php echo e($user->getPlan->name); ?></span>
                            ...
                            <div class="profile-widget-name"><?php echo e($user->name); ?> <?php if(Auth::user()->type != 'admin'): ?><div class="text-muted d-inline font-weight-normal"><div class="slash"></div> <?php echo e($user->permission); ?></div><?php endif; ?></div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/taskly/saas/site/resources/views/users/index.blade.php ENDPATH**/ ?>