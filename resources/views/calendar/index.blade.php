...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $("body #calendar .fc-head .fc-sun").text('{{__('Sun')}}');
            $("body #calendar .fc-head .fc-sat").text('{{__('Sat')}}');
            $("body #calendar .fc-head .fc-mon").text('{{__('Mon')}}');
            $("body #calendar .fc-head .fc-tue").text('{{__('Tue')}}');
            $("body #calendar .fc-head .fc-wed").text('{{__('Wed')}}');
            $("body #calendar .fc-head .fc-thu").text('{{__('Thu')}}');
            $("body #calendar .fc-head .fc-fri").text('{{__('Fri')}}');
        });
