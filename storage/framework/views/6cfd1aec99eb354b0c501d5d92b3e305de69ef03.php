<form class="pl-3 pr-3" method="post" enctype="multipart/form-data" action="<?php echo e(route('plans.store')); ?>">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-6">
    ...
    <div class="row">
            ...
            <div class="form-group">
                ...
                <select name="duration" id="duration" class="form-control">
                    <?php $__currentLoopData = $plan->arrDuration(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $duration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($key); ?>"><?php echo e(__($duration)); ?></option>
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <span><small><?php echo e(__('Please upload a valid image file. Size of image should not be more than 2MB.')); ?></small></span>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="form-group">
        <button class="btn btn-primary" type="submit"><?php echo e(__('Create Plan')); ?></button>
    </div>
</form><?php /**PATH /var/www/html/taskly/saas/site/resources/views/plans/create.blade.php ENDPATH**/ ?>