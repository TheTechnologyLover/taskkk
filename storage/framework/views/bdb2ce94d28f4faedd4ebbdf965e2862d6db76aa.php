                                ...
                                <div class="col-lg-4">
                                    <div class="card widget-flat">
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-muted font-weight-normal mt-0" title="Number of Customers"><?php echo e(__('Total Users')); ?></h5>
                                            <h3 class="mt-3 mb-3"><?php echo e(number_format($totalUsers)); ?></h3>
                                            <p class="mb-0 text-muted">
                                                <span class="text-primary mr-2">
                                                    <i class="mdi mdi-chess-king"></i> <?php echo e(number_format($totalPaidUsers)); ?></span>
                                                <span class="text-nowrap"><?php echo e(__('Paid Users')); ?></span>
                                            </p>
                                        </div> <!-- end card-body-->
                                    </div> <!-- end card-->
                                </div>
                                <div class="col-lg-4">
                                    <div class="card widget-flat">
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-muted font-weight-normal mt-0" title="Number of Customers"><?php echo e(__('Total Orders')); ?></h5>
                                            <h3 class="mt-3 mb-3"><?php echo e(number_format($totalOrders)); ?></h3>
                                            <p class="mb-0 text-muted">
                                                <span class="text-primary mr-2">
                                                    <i class="mdi mdi-cash-multiple"></i> $<?php echo e(number_format($totalOrderAmount)); ?></span>
                                                <span class="text-nowrap"><?php echo e(__('Total Order Amount')); ?></span>
                                            </p>
                                        </div> <!-- end card-body-->
                                    </div> <!-- end card-->
                                </div>
                                <div class="col-lg-4">
                                    <div class="card widget-flat">
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-muted font-weight-normal mt-0" title="Number of Customers"><?php echo e(__('Total Plan')); ?></h5>
                                            <h3 class="mt-3 mb-3"><?php echo e(number_format($totalPlans)); ?></h3>
                                            <p class="mb-0 text-muted">

                                                <span class="text-primary mr-2"><i class="mdi mdi-cards-heart"></i><?php if($mostPlans): ?> <?php echo e($mostPlans->name); ?> <?php else: ?> - <?php endif; ?></span>
                                                <span class="text-nowrap"><?php echo e(__('Most purchase plan')); ?></span>
                ...
                <div class="col-12">
                    <div class="card animated">
                        <div class="card-header">
                            <h4><?php echo e(__('Recent Order')); ?></h4>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if($task->status=='todo'): ?>
                                                    <span class="badge badge-primary"><?php echo e(__(ucfirst($task->status))); ?></span>
                                                <?php elseif($task->status=='in progress'): ?>
                                                    <span class="badge badge-warning"><?php echo e(__(ucfirst($task->status))); ?></span>
                                                <?php elseif($task->status=='review'): ?>
                                                    <span class="badge badge-danger"><?php echo e(__(ucfirst($task->status))); ?></span>
                                                <?php elseif($task->status=='done'): ?>
                                                    <span class="badge badge-success"><?php echo e(__(ucfirst($task->status))); ?></span>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                            ...
                                            <?php if($currantWorkspace->permission == 'Owner' || Auth::user()->getGuard() == 'client'): ?>
                                            <td>
...
window.onload = function() {
    ...
    <?php elseif(isset($currantWorkspace) && $currantWorkspace): ?>
    <!-- demo app -->
    <script>
...
var config = {
		...
		var config1 = {
			...
			data: {
				...
				labels: <?php echo json_encode($arrProcessPer); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Taskly2/site2/resources/views/home.blade.php ENDPATH**/ ?>