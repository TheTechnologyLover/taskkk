<aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
        ...
        <?php endif; ?>
        <?php if(isset($currantWorkspace) && $currantWorkspace): ?>
            <li class="<?php echo e((Request::route()->getName() == 'chats.index') ? ' active' : ''); ?>">
                <a href="<?php echo e(route('chats.index',$currantWorkspace->slug)); ?>">
...
<?php /**PATH /var/www/html/taskly/saas/site2/resources/views/partials/sidebar.blade.php ENDPATH**/ ?>