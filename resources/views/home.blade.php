                                    ...
                                    @foreach($tasks as $task)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if($task->status=='todo')
                                                    <span class="badge badge-primary">{{__(ucfirst($task->status))}}</span>
                                                @elseif($task->status=='in progress')
                                                    <span class="badge badge-warning">{{__(ucfirst($task->status))}}</span>
                                                @elseif($task->status=='review')
                                                    <span class="badge badge-danger">{{__(ucfirst($task->status))}}</span>
                                                @elseif($task->status=='done')
                                                    <span class="badge badge-success">{{__(ucfirst($task->status))}}</span>
                                                @endif
                                            </td>
                                            <td>
