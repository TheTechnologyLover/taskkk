<?php $__env->startSection('content'); ?>
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h4><?php echo e(__('Client Login')); ?></h4>
            <div class="card-header-action">
                <div class="dropdown card-widgets">
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-sm btn-secondary"><?php echo e(__('User Login')); ?></a>
                </div>
            </div>
        </div>
        <div class="card-body">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Taskly2/site2/resources/views/auth/client_login.blade.php ENDPATH**/ ?>