...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $("body #calendar .fc-right .fc-today-button").text('<?php echo e(__('Today')); ?>');
            $("body #calendar .fc-head .fc-sun").text('<?php echo e(__('Sun')); ?>');
            $("body #calendar .fc-head .fc-sat").text('<?php echo e(__('Sat')); ?>');
            $("body #calendar .fc-head .fc-mon").text('<?php echo e(__('Mon')); ?>');
            $("body #calendar .fc-head .fc-tue").text('<?php echo e(__('Tue')); ?>');
            $("body #calendar .fc-head .fc-wed").text('<?php echo e(__('Wed')); ?>');
            $("body #calendar .fc-head .fc-thu").text('<?php echo e(__('Thu')); ?>');
            $("body #calendar .fc-head .fc-fri").text('<?php echo e(__('Fri')); ?>');
        });
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Taskly2/site2/resources/views/calendar/index.blade.php ENDPATH**/ ?>